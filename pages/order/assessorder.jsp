		...
		<form action="${base }/servlet/OrderServlet?method=assessOrder"
			...
			<table width="1000" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
						<input type="radio" value="1" id="attitude" name="attitude">1分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="2" id="attitude" name="attitude">2分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="3" id="attitude" name="attitude">3分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="4" id="attitude" name="attitude">4分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="5" id="attitude" name="attitude" checked="checked">5分&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
					...
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
						<input type="radio" value="1" id="quality" name="quality">1分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="2" id="quality" name="quality">2分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="3" id="quality" name="quality">3分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="4" id="quality" name="quality">4分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="5" id="quality" name="quality" checked="checked">5分&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
					...
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
						<input type="radio" value="1" id="speed" name="speed">1分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="2" id="speed" name="speed">2分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="3" id="speed" name="speed">3分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="4" id="speed" name="speed">4分&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" value="5" id="speed" name="speed" checked="checked">5分&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td  height="25" align="center" valign="middle" bgcolor="#F9FCFF">
