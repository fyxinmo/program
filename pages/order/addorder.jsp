...
-->
	...
	<body>
		<form action="${base }/servlet/OrderServlet?method=saveOrder"
			...
			<table width="545" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td height="25" colspan="2" align="left" valign="middle"
						...
						<span class="STYLE1"> 添加&nbsp;叫件信息</span>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" valign="middle" bgcolor="#F9FCFF">
						<input type="text" id="ostel" name="ostel">
						<span style="color: red;">*</span>
					</td>
				</tr>
				<tr>
					...
					<td align="left" valign="middle" bgcolor="#F9FCFF">
						<input type="text" id="osadd" name="osadd">
						<span style="color: red;">*</span>
					</td>
				</tr>
				<tr>
