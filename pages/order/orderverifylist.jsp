...
-->
	...
	<body>
		<form action="${base }/servlet/OrderServlet?method=findVerifyOrder"
			method="post">
			...
			<table width="1000" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="211" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
						序号
					</td>
					
					<td width="179" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
						提交日期
					</td>
					<td width="146" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
						发件人姓名
					</td>
					<td width="138" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
						发件人电话
					</td>
					
					<td width="189" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
						地址
					</td>
					
					<td width="130" class="STYLE4" align="center" valign="middle"
						bgcolor="#F9FCFF">
				...
				<c:forEach var="item" varStatus="i" items="${list}">
					...
					<tr>
						...
						<td align="center" valign="middle" bgcolor="#F9FCFF">
							...
							<a
								href="${base }/servlet/OrderServlet?method=verifyPage&oid=${item.oid}">分配</a>
